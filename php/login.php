                                        ...
                                        <div class="mt-4">
                                            <form action="login.php" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input name="email" type="email" class="form-control" id="username" placeholder="Enter Email" required>
                                                </div>
...
<!-- Mirrored from themesbrand.com/velzon/html/master/auth-signin-cover.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 10:17:17 GMT -->
</html>