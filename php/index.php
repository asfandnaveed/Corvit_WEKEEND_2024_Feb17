...
if( isset($_POST['email']) ){
    ...
    $sql = "INSERT INTO users (name,email,password,phone_no,address,created_at) VALUE ('$name','$email','$encPassword','$phoneNumber','$address','$dateTime')";
...
<head>
    ...
    <meta content="Sign Up" name="description" />
                                        ...
                                        <div class="mt-4">
                                            <form method="POST" action="index.php" class="needs-validation">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input name="phone_no" type="text" class="form-control" id="username" placeholder="Enter Phone Number" required>
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input name="address" type="text" class="form-control" id="username" placeholder="Enter Address" required>
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="mb-4">
                                                    <p class="mb-0 fs-12 text-muted fst-italic">By registering you agree to the Corvit <a href="#" class="text-primary text-decoration-underline fst-normal fw-medium">Terms of Use</a></p>
                                                </div>
...
<!-- Mirrored from themesbrand.com/velzon/html/master/auth-signup-cover.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2024 10:17:19 GMT -->
</html>